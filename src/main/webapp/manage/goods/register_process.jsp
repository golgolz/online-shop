...
%>
		...
		location.href="http://localhost/online-shop/manage/goods/detail.jsp";
<%		} %>
</script>
<%
	    ...
	    <script type="text/javascript">
		    alert("등록이 완료되었습니다.");
		    location.href="http://localhost/online-shop/manage/goods/detail.jsp?code=<%= code %>";
	    </script>
	    <%
	} catch(SQLException se){
	    se.printStackTrace();
	    // location.href="http://localhost/online-shop/error/err_500.html"
	} catch(Exception e){
	    e.printStackTrace();
	}
%>