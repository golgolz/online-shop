...
<script type="text/javascript">
	$(function(){
    	...
    	$("#btnAllSearch").click(function() {
    		location.href="http://objec.sist.co.kr/manage/notice/notice.jsp";
    	});//click
	});
	...
	<main
		...
		<div class="container-fluid py-4">
            ...
            <a href="/board/free/write.html?board_no=1" class="btnSubmitFix sizeS displaynone">글쓰기</a>
					...
					<form id="searchForm" name="" method="get" target="_top">
						...
						<div class="xans-element- xans-board xans-board-search-1002 xans-board-search xans-board-1002 ">
								...
								<p>
									...
									<a id="btnInsert" href="http://objec.sist.co.kr/manage/notice/notice_write.jsp" class="btnEmFix4">작성</a>
								</p>
						</div>
					</form>
					<%-- <%
					...
					<%
						String pageNation = 
							    pageController.createPagingBtns("http://objec.sist.co.kr/manage/notice/notice.jsp", params
