...
<div class="ec-base-button ">
            ...
            <span class="gRight">
            	<input type="button" value="등록" class="btnSubmitFix sizeS" id="btnWrite" name="btnWrite"/>
            	<input type="button" value="취소" class="btnBasicFix sizeS" id="btnCancel" name="btnCancel"/>
