...
%>
	<script>
		...
		location.href = "http://objec.sist.co.kr/manage/order/orders.jsp";
	</script>
<%
	}
				...
				success: function(result){
					if(result.flag){
						...
						$.each(goodsList, function(i, goods){
							...
							output += "<td><a href='http://objec.sist.co.kr/goods/detail.jsp?goods=" + goods.code +"'>";
							output += "<img src='http://objec.sist.co.kr/assets/images/goods/" + goods.defaultImage + "' width='40' height='40'></a></td>";
							output += "<td class='tal'><a href='http://objec.sist.co.kr/goods/detail.jsp?goods=" + goods.code + "'>" + goods.name + "</a></td>";
