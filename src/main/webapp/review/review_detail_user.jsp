...
<p class="thumbnail">
<a href="#"><img src="http://object.sist.co.kr/assets/images/goods/<c:out value='${rVO.defaultImg}'/>" style="width:60px; height:60px""/></a></p>
...
<div class="ec-base-button ">
            ...
            <span class="gRight">
                ...
                <a href="http://object.sist.co.kr/review/review_read_frm.jsp?reviewId=${rVO.reviewId }&title=${rVO.title }&content=${rVO.content }&currentPage=${empty param.currentPage ?1:param.currentPage}" class="btnEmFix sizeS ">수정</a>
            </span>
        </div>
</div>
</form></div>
