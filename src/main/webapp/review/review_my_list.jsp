...
<!-- 	    		<th class="cnt">조회수</th> -->
	    	...
	    	<tbody id="tbody" align="center">
				...
				<td> <img src="http://192.168.10.211/assets/images/goods/<c:out value='${rVO.defaultImg}'/>" style="width:60px; height:60px">
	    ...
	    <form action="review_my_list.jsp" name="frmBoard" id="frmBoard" method="get">
	    	...
	    	<!-- <a href="http://192.168.10.211/review/review_write.jsp?code=SAMSUNG_S24_1&cartId=20240419131320" class="btn btn-warning btn-sm">글쓰기</a> -->
