...
<%
	...
	try{
	  ...
	  %>
	  <%-- <c:redirect url="http://object.sist.co.kr/review/review_my_list.jsp"/> --%>
...
<div class="ec-base-box typeProduct  ">
            <p class="thumbnail"><a href=""><img id="iPrdImg" src="http://object.sist.co.kr/assets/images/goods/<c:out value='${rVO.defaultImg}'/>" onerror="this.src='//img.echosting.cafe24.com/thumb/75x75.gif'" alt=""/></a></p>
...
<div class="ec-base-button ">
            <span class="gLeft">
                <a href="http://object.sist.co.kr/review/review_my_list.jsp" class="btnNormalFix sizeS">목록</a>
            </span>
            <span class="gRight">
            <input type="button" value="수정" class="btnSubmitFix sizeS" id="btnUpdate"/>
                <a href="http://object.sist.co.kr/review/review_my_list.jsp" class="btnBasicFix sizeS">취소</a>
            </span>
        </div>
</div>
			<!-- golgolz end -->
