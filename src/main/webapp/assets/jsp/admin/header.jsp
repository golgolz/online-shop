...
<aside
	...
	<div class="sidenav-header">
		<a class="navbar-brand m-0"
			href="http://192.168.10.211/manage/dashboard/index.jsp"
		...
		<ul class="navbar-nav">
			...
			<li class="nav-item">
				<a 
					id="order_menu"
					class="nav-link text-white"
					href="http://192.168.10.211/manage/order/orders.jsp?page=1">
			...
			<li class="nav-item">
				<a
					id="refund_menu"
					class="nav-link text-white"
					href="http://192.168.10.211/manage/refund/refunds.jsp?page=1">
			...
			<li class="nav-item">
				<a 
					id="goods_menu"
					class="nav-link text-white"
					href="http://192.168.10.211/manage/goods/goods.jsp?page=1">
			...
			<li class="nav-item">
				<a
					id="user_menu"
					class="nav-link text-white"
					href="http://192.168.10.211/manage/user/user.jsp">
			...
			<li class="nav-item">
				<a
					id="review_menu"
					class="nav-link text-white"
					href="http://192.168.10.211/manage/review/review_board_list.jsp">
			...
			<li class="nav-item">
				<a
					id="notice_menu"
					class="nav-link text-white"
					href="http://192.168.10.211/manage/notice/notice.jsp">
