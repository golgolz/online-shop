...
<script type="text/javascript">
	$(function(){
		var orderBaseURL = "http://localhost/online-shop/cart/input_process.jsp?code=<%= currentGoods.getCode() %>&quantity=";
		var buyBaseURL = "http://localhost/online-shop/order/order_form.jsp?code=<%= currentGoods.getCode() %>&isCart=0&quantity=";
