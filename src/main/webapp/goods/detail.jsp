...
<script type="text/javascript">
	$(function(){
		var orderBaseURL = "http://object.sist.co.kr/cart/input_process.jsp?code=<%= currentGoods.getCode() %>&quantity=";
		var buyBaseURL = "http://object.sist.co.kr/order/order_form.jsp?code=<%= currentGoods.getCode() %>&isCart=0&quantity=";
				...
				success: function(reviewObj){
					if(reviewObj.flag){
						...
						$.each(reviews, function(i, review) {
						    ...
						    output += "<a href='http://object.sist.co.kr/review/review_detail_user.jsp?reviewId=" + review.review_id + "'>" + review.title + "</a></td>"; // </td> 추가
		...
		$(".need_login").click(function(event){
		 	$.ajax({
		        url: "http://object.sist.co.kr/goods/check_login.jsp",
		        type: "GET",
		        dataType: "JSON",
		        error: function(xhr){
		        ...
		        success: function(response) {
		             if (!response.flag) {
		     			event.preventDefault();
		                //alert('로그인이 필요합니다.22');
		                location.href = 'http://object.sist.co.kr/user/login/userLogin.jsp';
		            } 
		        }
		    });
		});
		...
		<div id="container">
			<div id="contents">
				<div
					...
					<span>현재 위치</span>
					<ol>
						<li><a href="http://object.sist.co.kr/index.jsp">홈</a></li>
						<li class=""><a
							href="http://object.sist.co.kr/goods/best.jsp">BEST</a></li>
					</ol>
				</div>
					...
					<div class="detailArea">
						<div class="xans-element- xans-product xans-product-image imgArea">
							<div class="keyImg">
								<div class="thumbnail">
										<img
										src="http://object.sist.co.kr/assets/images/goods/<%= currentGoods.getDefaultImage() %>"
							...
							<div class="infoArea" style="">
										...
										<tbody>
											<tr>
												...
												<td><span class="quantity">
														...
														<img
															src="http://object.sist.co.kr/assets/images/goods/btn_count_up.gif"
															class="QuantityUp up" id="quantity_up"/>
														<img
															src="http://object.sist.co.kr/assets/images/goods/btn_count_down.gif"
								...
								<div class="xans-element- xans-product xans-product-action">
									<div class="ec-base-button">
										<a href="http://object.sist.co.kr/cart/input_process.jsp?code=<%= currentGoods.getCode() %>&quantity=" class="sub_cart need_login" id="sub_cart">장바구니</a>
										<a href="http://object.sist.co.kr/wishlist/wishlist_insert_process.jsp?code=<%= currentGoods.getCode() %>" class="sub_wish need_login">관심상품</a>
										<a href="http://object.sist.co.kr/order/order_form.jsp?code=<%= currentGoods.getCode() %>&isCart=0&quantity=" class="first sub_buy need_login" id="sub_buy">
				...
				<div class="xans-element- xans-product xans-product-additional">
					...
					<div id="prdDetail" class="tab_box01">
						<div class="cont">
							<p>
								<img
									src="http://object.sist.co.kr/assets/images/goods/<%= currentGoods.getDetailImage() %>"
					...
					<div id="prdReview" class="tab_box02" style="display: none">
						<div class="board">
										...
										<tbody class="center">
											...
											<tr class="xans-record-">
												...
												<td class="subject left txtBreak">
													<a href="http://object.sist.co.kr/review/review_detail_user.jsp?reviewId=<%= review.getReviewId() %>">
														<%= review.getTitle() %>
													</a>
												<td><%= review.getId() %></td>
							...
							<%
					        	String pageNation = 
					        	pageController.createPagingBtns("http://object.sist.co.kr/goods/detail.jsp", params
