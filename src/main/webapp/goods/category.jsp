...
<head>
	...
	<!-- golgolz start -->
    <link href="http://object.sist.co.kr/assets/css/goods/category.css" rel="stylesheet" />
	...
	<div id="wrap">
		<div id="main">
			...
			<div class="xans-element- xans-product xans-product-menupackage">
	        	<div class="xans-element- xans-product xans-product-headcategory path">
	          		...
	          		<ol>
	            		...
	            		<li class="">
	              			<a href="http://object.sist.co.kr/goods/category.jsp?category=${param.category}"><%= category %></a>
	            		</li>
	            		<% if(subCategory != null){ %>
	            		...
	            		<ul
	              		...
	              		class="xans-element- xans-product xans-product-orderby">
	              			<li class="xans-record-">
	                			<a href="http://object.sist.co.kr/goods/category.jsp?category=<%= category %>&sort=new<%= subCategory == null ? "": "&sub_category=" + subCategory %>&page=1">신상품</a>
	              			</li>
	              			<li class="xans-record-">
	                			<a href="http://object.sist.co.kr/goods/category.jsp?category=<%= category %>&sort=best<%= subCategory == null ? "": "&sub_category=" + subCategory %>&page=1">판매순</a>
	              			</li>
	              			<li class="xans-record-">
	                			<a href="http://object.sist.co.kr/goods/category.jsp?category=<%= category %>&sort=high_price<%= subCategory == null ? "": "&sub_category=" + subCategory %>&page=1">높은가격</a>
	              			</li>
	              			<li class="xans-record-">
	                			<a href="http://object.sist.co.kr/goods/category.jsp?category=<%= category %>&sort=low_price<%= subCategory == null ? "": "&sub_category=" + subCategory %>&page=1">낮은가격</a>
	              			</li>
	              			<li class="xans-record-">
	                			<a href="http://object.sist.co.kr/goods/category.jsp?category=<%= category %>&sort=most_review<%= subCategory == null ? "": "&sub_category=" + subCategory %>&page=1">리뷰순</a>
	              			</li>
	            		</ul>
	          		</div>
	        	</div>
	        ...
	        <div class="xans-element- xans-product xans-product-listmain-2 xans-product-listmain xans-product-2 ec-base-product typeThumb sort_pro">
		        <ul class="prdList grid5">
		            ...
		            <li id="anchorBoxId_6371" class="xans-record-">
		                <div class="box">
		                    <div class="thumbnail">
		                        <div class="prdImg">
		                            <a href="http://object.sist.co.kr/goods/detail.jsp?goods=<%= goods.getCode() %>" name="anchorBoxName_6371">
		                                <img src="http://object.sist.co.kr/assets/images/goods/<%= goods.getDefaultImage() %>" id="eListPrdImage6371_3" alt="[오브젝트] 2024 오브젝트 다이어리 (날짜형)">
		                            </a>
		                        </div>
		                        <span class="wish">
		                    ...
		                    <div class="description">
		                        <div class="name">
		                            <a href="http://object.sist.co.kr/goods/detail.jsp" class="">
		        ...
		        <%
		        	String pageNation = 
		        	pageController.createPagingBtns("http://object.sist.co.kr/goods/category.jsp", params
